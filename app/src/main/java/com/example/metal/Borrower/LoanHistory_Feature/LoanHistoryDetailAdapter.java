...
public class LoanHistoryDetailAdapter extends RecyclerView.Adapter<LoanHistoryDetailViewHolder> {
    private Context context;
    private List<CollectorDailyCollectionModel> dataList;
    public LoanHistoryDetailAdapter(Context context, List<CollectorDailyCollectionModel> dataList) {
    ...
    @NonNull
    @Override
    public LoanHistoryDetailViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_secretary_paid_item, parent, false);
        return new LoanHistoryDetailViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LoanHistoryDetailViewHolder holder, int position) {
    ...
    private void setDayDetails(LoanHistoryDetailViewHolder holder, CollectorDailyCollectionModel currentLoanModel, String paidOrNot, Date day, double amountPaid, double toCollect, String proofPayment, View dayView, TextView dateView, TextView paymentView, TextView nameView) {
...
class LoanHistoryDetailViewHolder extends RecyclerView.ViewHolder{
    ...
    public LoanHistoryDetailViewHolder(@NonNull View itemView) {
        super(itemView);
