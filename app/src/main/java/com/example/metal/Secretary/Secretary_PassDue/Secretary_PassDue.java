...
import com.example.metal.Borrower.LoanHistory_Feature.LoanHistoryAdapter;
...
public class Secretary_PassDue extends AppCompatActivity {
    ...
    PassDueAdapter adapter;
    ImageButton back;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_secretary_pass_due);
        ...
        list = new ArrayList<>();
        adapter = new PassDueAdapter(this, list);
    ...
    protected void onStart() {
        ...
        eventListener = databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) { // Check if snapshot exists to avoid null issues
                    for (DataSnapshot itemSnapshot : snapshot.getChildren()) {
                        ...
                        if (dataClass != null && "Past Due".equals(dataClass.getStatus())) {
                            list.add(dataClass); // Add to list if the userId matches the current user and status is "Past Due"
                        }
                    ...
                    Toast.makeText(Secretary_PassDue.this, "No data available.", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                progressDialog.dismiss();
                dialog.dismiss();
                Toast.makeText(Secretary_PassDue.this, "Failed to load data.", Toast.LENGTH_SHORT).show();
            }
        });
