...
public class SecretaryAccountApprovalRejected extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_secretary_account_approval_rejected, container, false);
        ...
        eventListener = databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot itemSnapshot : snapshot.getChildren()) {
                    ...
                    if (dataClass != null && "yes".equals(dataClass.getAccountDocumentsComplete()) && "rejected".equals(dataClass.getAccountStatus())) {
                        userList.add(dataClass);
                    }
                }

                // Sort the userList based on the timestamp
