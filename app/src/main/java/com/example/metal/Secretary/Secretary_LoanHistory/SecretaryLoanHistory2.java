...
public class SecretaryLoanHistory2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secretary_loan_history2);
        ...
        eventListener = databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) { // Check if snapshot exists to avoid null issues
                    ...
                    Toast.makeText(SecretaryLoanHistory2.this, "No data available.", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                progressDialog.dismiss();
                dialog.dismiss();
                Toast.makeText(SecretaryLoanHistory2.this, "Failed to load data.", Toast.LENGTH_SHORT).show();
            }
        });
