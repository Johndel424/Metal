...
import com.example.metal.Borrower.Chat_Feature.MessageAdapter;
import com.example.metal.Borrower.Chat_Feature.MessageImagesActivity;
import com.example.metal.Borrower.Chat_Feature.MessageModel;
...
public class SecretaryChat extends AppCompatActivity {
    String chatRoomId, number , secretaryPhone ,borrowerPhone, currentUserUid,borrowerRead;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent infoIntent = new Intent(SecretaryChat.this, MessageImagesActivity.class);
                ...
                result -> {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        if (uri != null) {
                            ...
                            Toast.makeText(SecretaryChat.this, "Image cannot be loaded", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        // If result is not OK, show a toast indicating that no image was selected
                        imageRelativeHolder.setVisibility(View.GONE);
                        Toast.makeText(SecretaryChat.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        statusText.setText(borrowerRead);
            ...
            if (!messageText.isEmpty()) {
                ...
                chatroomRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        String borrowerRead = dataSnapshot.child("statusBorrower").getValue(String.class);
                ...
                Toast.makeText(SecretaryChat.this, "No message or image selected", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void loadMessages() {
        ...
        messagesRef.limitToLast(50).addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(SecretaryChat.this, "Failed to load messages: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
                ...
                chatroomRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            String secretaryProfile = dataSnapshot.child("secretaryProfile").getValue(String.class);
                            String secretaryName = dataSnapshot.child("secretaryName").getValue(String.class);
                            ...
                            borrowerRead = dataSnapshot.child("statusBorrower").getValue(String.class);
                            statusText.setText(borrowerRead);
                                ...
                                call.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        if (!number.isEmpty()) {
                                            ...
                                            Toast.makeText(SecretaryChat.this, "Phone number is empty", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            } else {
    ...
    private void makeCall(String number) {
        ...
        if (ContextCompat.checkSelfPermission(SecretaryChat.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(SecretaryChat.this, new String[]{Manifest.permission.CALL_PHONE}, CALL_PERMISSION_REQUEST_CODE);
        } else {
        ...
        if (uri != null) {
            ...
            storageReference.putFile(uri)
                    ...
                    .addOnFailureListener(e -> {
                        ...
                        // Handle failure
                        Toast.makeText(SecretaryChat.this, "Failed to upload image: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        } else {
            Toast.makeText(SecretaryChat.this, "No Image Selected", Toast.LENGTH_SHORT).show();
        }
    ...
    private void sendImageMessage() {
        ...
        usersRef.child(currentUserUid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                // Handle error
                Toast.makeText(SecretaryChat.this, "Failed to send image: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    //save text or image in database
    private void saveMessageToDatabase(MessageModel message) {
        // Show sending message
        Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content), "Sending message...", Snackbar.LENGTH_INDEFINITE);
        snackbar.show();
            ...
            messagesRef.child(messageId).setValue(message)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            lastMessageInfo.put("statusBorrower", "unread");
                            lastMessageInfo.put("statusSecretary", "read");
                            ...
                            chatRoomRef.updateChildren(lastMessageInfo)
                                    ...
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            snackbar.dismiss();
                                            Snackbar.make(findViewById(android.R.id.content), "Error updating last message: " + e.getMessage(), Snackbar.LENGTH_SHORT).show();
                                        }
                                    });
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            snackbar.dismiss();
                            Snackbar.make(findViewById(android.R.id.content), "Error saving message: " + e.getMessage(), Snackbar.LENGTH_SHORT).show();
                        }
                    });
        } else {
            snackbar.dismiss();
            Snackbar.make(findViewById(android.R.id.content), "Message ID is null", Snackbar.LENGTH_SHORT).show();
        }
    }

    private void showNotification(String message) {
        String channelId = "default"; // Ensure this matches the ID you created
