...
import com.example.metal.Borrower.LoanHistory_Feature.LoanHistoryDetailAdapter;
...
public class LoanHistoryDetail2 extends AppCompatActivity {
    ...
    LoanHistoryAdapter2 adapter;
    String receivedVariable;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_loan_history_detail2);
        ...
        adapter = new LoanHistoryAdapter2(this, currentLoanList);
        ...
        eventListener = databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) { // Check if snapshot exists to avoid null issues
                    ...
                    Toast.makeText(LoanHistoryDetail2.this, "No data available.", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                progressDialog.dismiss();
                dialog.dismiss();
                Toast.makeText(LoanHistoryDetail2.this, "Failed to load data.", Toast.LENGTH_SHORT).show();
            }
        });
